...
- `Textbook/01_Introduction/1.5-Quickstart_copy_edit_first_problem.html`: Walks you through a fast first win by copy-editing a complete PGML-first problem. After finishing, you can take a working template and make small changes without breaking grading. Use it when you want to move from reading to shipping your first working item.
...
- `Textbook/05_Different_Question_Types/5.9-ADAPT_workflow_checklist.html`: Provides a practical checklist for creating, testing, and assigning WeBWorK questions in ADAPT. After finishing, you can follow a repeatable copy-edit process that reduces surprises in student view and grading. Use it when you are preparing a new assignment or onboarding a new instructor.
  SEO tags: cloning workflow, preview testing, assignment publishing
- `Textbook/05_Different_Question_Types/5.10-QA_and_common_failures.html`: Collects a compact QA pass focused on the most common failure modes in biology-style WeBWorK prompts. After finishing, you can test answer blank binding, text-variant handling, units and tolerances, and randomization plausibility quickly. Use it before publishing any new or revised question to students.
  SEO tags: QA pass, blank binding, randomization failures
